...
public class GZAgentLauncherTest {
    ...
    private GZAgentLauncher wsAgentLauncher;

    @BeforeMethod
    public void setUp() throws Exception {
        wsAgentLauncher = new GZAgentLauncher(() -> machineProcessManager,
    ...
    public void shouldStartWsAgentUsingMachineExec() throws Exception {
        ...
        Mockito.verify(machineProcessManager).exec(Matchers.eq(WORKSPACE_ID),
                                                   ...
                                                   Matchers.eq(new CommandImpl("org.eclipse.che.gz-agent",
                                                                               "script\n" +
