...
public class EnvironmentRamCalculatorTest {
  ...
  public void testCalculatesRamOfEnvironmentWithMultipleMachines() throws Exception {
    when(machineConfig1.getAttributes())
        .thenReturn(ImmutableMap.of(MachineConfig.MEMORY_LIMIT_ATTRIBUTE, "2147483648"));
    when(machineConfig2.getAttributes())
        .thenReturn(ImmutableMap.of(MachineConfig.MEMORY_LIMIT_ATTRIBUTE, "536870912"));
  ...
  public void testCalculatesRamOfRuntimeWithMultipleMachines() throws Exception {
    when(machine1.getAttributes())
        .thenReturn(ImmutableMap.of(Machine.MEMORY_LIMIT_ATTRIBUTE, "805306368"));
    when(machine2.getAttributes())
        .thenReturn(ImmutableMap.of(Machine.MEMORY_LIMIT_ATTRIBUTE, "805306368"));
