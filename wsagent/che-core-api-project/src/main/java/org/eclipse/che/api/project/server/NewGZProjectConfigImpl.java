...
/**
 * Implementation of {@link NewGZProjectConfig} for creating project
 *
 * @author gazarenkov
 */
public class NewGZProjectConfigImpl implements NewGZProjectConfig {
     ...
     */
    public NewGZProjectConfigImpl(String path,
                                String type,
                                List<String> mixins,
                                String name,
                                String description,
     ...
     *         source configuration
     */
    public NewGZProjectConfigImpl(String path, String name, String type, SourceStorage origin) {
     ...
     * @param path
     */
    public NewGZProjectConfigImpl(Path path) {
