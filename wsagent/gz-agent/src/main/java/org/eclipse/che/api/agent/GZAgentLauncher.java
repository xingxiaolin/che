 ...
 */
@Singleton
public class GZAgentLauncher implements AgentLauncher {
    protected static final Logger LOG = LoggerFactory.getLogger(GZAgentLauncher.class);

    private static final   String WS_AGENT_PROCESS_OUTPUT_CHANNEL = "workspace:%s:gzext-server:output";
    ...
    @Inject
    public GZAgentLauncher(Provider<MachineProcessManager> machineProcessManagerProvider,
    ...
    public String getAgentId() {
        return "org.eclipse.che.gz-agent";
    }
